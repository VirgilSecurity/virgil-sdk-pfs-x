...
@objc(VSPSecureChatPreferences) public class SecureChatPreferences: NSObject {
    ...
    @objc public var insensitiveDataStorage: InsensitiveDataStorage
    
    /// PFS service url
    @objc public var pfsUrl: URL?
    ...
    @objc public var exhaustedOneTimeKeysTtl: TimeInterval
    ...
    @objc convenience public init(crypto: VSSCryptoProtocol, identityPrivateKey: VSSPrivateKey, identityCard: VSSCard, accessToken: String) throws {
